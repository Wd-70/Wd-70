...
## 📌 프로젝트 개요
- **목표**: Wd-70 개발자의 프로필과 서비스를 소개하는 크몽 스타일의 포트폴리오 웹사이트
- **주요 기술**: Next.js 14, TypeScript, Tailwind CSS, Framer Motion, Flutter
- **배포**: Vercel (무료 계정)
...
### 1. 서비스 카테고리 구성
- **모바일 앱**: Flutter로 개발한 모바일 애플리케이션
  - Standard: 생일축하 앱, 포모도로 타이머
  - Premium: 계시록 빈칸채우기
- **웹사이트**: Next.js로 개발한 웹 애플리케이션
  - Standard: 포트폴리오 웹사이트 (기본)
- **업무 자동화**: 자동화 스크립트 및 도구
  - (추후 추가 예정)

### 2. 가격 정책
- **Standard**: 기본 기능 제공
- **Deluxe**: 추가 기능 및 커스터마이징 옵션
- **Premium**: 프리미엄 기능 및 우선 지원

### 3. 페이지 레이아웃
```
app/projects/
├── page.tsx                 # 서비스 목록 페이지
└── [category]/              # 카테고리별 서비스 목록
    └── [serviceId]/         # 개별 서비스 상세 페이지
        ├── page.tsx         # 서비스 상세 정보
        └── components/      # 서비스별 컴포넌트들
            ├── Pricing.tsx  # 가격 정책
            ├── Features.tsx # 기능 소개
            └── Gallery.tsx  # 작업물 갤러리
```
